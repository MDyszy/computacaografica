...
const Mob = [ // Matriz para projeção Cavalera ( ângulo de 45° - Arakaki)
...
function projCavalera(objeto){ // Função para projeção utilizando cavalera
    ...
    const M = multiplicaMatrizes(Mob, multiplicaMatrizes(translacaoM, multiplicaMatrizes(rotacaoM, escalaM)));
